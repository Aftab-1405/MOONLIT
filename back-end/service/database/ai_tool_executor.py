    ...
    def _get_schema_overview(
        ...
        try:
            ...
            if schema_context:
                ...
                # Fetch foreign keys
                all_foreign_keys_result = AIToolExecutor._get_foreign_keys(
                    user_id, db_config=db_config
                )
                ...
                if target_tables:
                    ...
                    fks = [
                        fk
                        for fk in fks
                        if fk.get("table_name") in target_set
                        or fk.get("referenced_table") in target_set
                    ]
            ...
            all_tables = AIToolExecutor._fetch_tables_with_config(
                db_config, db_type, db_name=database
            )
