    ...
    <Section sx={{ py: { xs: 8, md: 6 } }}>
      <Container maxWidth="md" sx={{ zIndex: 2, textAlign: "center" }}>
        <Stack spacing={3} alignItems="center">
          ...
          >
            Connect to your database, ask in plain English, and get instant
            results. No SQL expertise required. Your data never leaves your
            infrastructure.
          </Typography>
          ...
          <Stack spacing={1.25} alignItems="center" sx={{ pt: 1 }}>
            ...
            >
              {[
                ...
                {
                  src: "/logo-microsoft-sql-server.svg",
                  alt: "SQL Server",
                  hideXs: true,
                },
