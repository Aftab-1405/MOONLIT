  ...
  return (
    <Box
      sx={{
        ...
        py: 0.3,
        borderRadius: '6px',
        bgcolor: alpha(theme.palette.text.primary, isDark ? 0.05 : 0.035),
        border: '1px solid',
        borderColor: alpha(theme.palette.text.primary, isDark ? 0.06 : 0.04),
        transition: TRANSITIONS.default,
        '&:hover': {
          bgcolor: alpha(theme.palette.text.primary, isDark ? 0.075 : 0.05),
          borderColor: alpha(theme.palette.text.primary, isDark ? 0.1 : 0.07),
        },
      }}
    >
      <Typography
